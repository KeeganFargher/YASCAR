...
export class XSmashScraper implements SourceScraper {
    ...
    private extractCodes(html: string): ShiftCode[] {
        ...
        const boxRegex = /data-code-id="([A-Z0-9]{5}-[A-Z0-9]{5}-[A-Z0-9]{5}-[A-Z0-9]{5}-[A-Z0-9]{5})"/gi;
        ...
        while ((match = boxRegex.exec(html)) !== null) {
            ...
            const games = [GameTitle.BL4, GameTitle.BL3, GameTitle.BL2, GameTitle.WONDERLANDS];
