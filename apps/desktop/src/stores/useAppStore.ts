/**
 * Unified Zustand store for application state
 * Replaces: redemptionEvents.ts, redemptionLock.ts, networkStatus.ts, prop drilling
 */
...
export const selectRedemptionProgress = (state: AppState) => state.redemptionProgress;
