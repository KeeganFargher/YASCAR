    ...
    return (
        <div className="bg-bl-gray-dark/80 border-l-4 border-bl-orange text-bl-orange px-6 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <div className="font-display text-lg uppercase tracking-wide">CONNECTION LOST</div>
                    <div className="text-sm text-bl-gray-light">You appear to be offline. Some features may be unavailable.</div>
                </div>
            </div>
            <button
                onClick={handleRetry}
